...
const templates = [
  ...
  { title: 'Payment link', category: 'Refunds', body: 'Hi {{customer_name}},\n\nAs discussed, here is a secure payment link for order {{order_id}}:\n\n{{payment_link}}\n\nThe link is unique to you — once the payment goes through we will be notified automatically and can proceed straight away.\n\nDo let us know if you have any trouble with it!\n\n{{brand}} Support' },
