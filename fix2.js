...
fs.writeFileSync('./src/config/brands.js', content);
console.log('File written.');

const { getBrands } = require('./src/config/brands');
console.log('Type:', typeof getBrands);
console.log(typeof getBrands === 'function' ? '✅ FIXED' : '❌ STILL BROKEN');